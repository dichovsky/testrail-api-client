...
```json
{
  ...
  "sourceHash": "b71b6c0a6674078ca032e497ba8a9eee62cb26391f2dd9ee538942b5a3aaad35",
  "entrypoints": [
    "src/index.ts",
    "src/cli.ts"
  ],
  "publicApi": [
    ...
    },
    {
      ...
      "jsdoc": "Thrown when a request times out (408 / AbortError) or the response-body read deadline fires."
    },
    {
