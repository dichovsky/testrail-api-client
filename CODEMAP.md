...
```json
{
  ...
  "sourceHash": "d91ae43adcfa2c388ac758ba47f96d77a23e8d7066a3bcdb1e6f14991e2af285",
  "entrypoints": [
    "src/index.ts",
    "src/cli.ts"
  ],
  "publicApi": [
    ...
    },
    {
      ...
      "file": "src/types.ts",
      "line": 369,
      "signature": "export interface HistoryChange { field?: string | null; type_id?: number | null; old_text?: string | null; new_text?: string | null; label?: string | null; options?: unknown[] | null; old_value?: unkn…",
      "typeOnly": true
    },
    {
      "name": "HistoryEntry",
