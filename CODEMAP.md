...
| `getCases` | ? | `?` | [279](src/client.ts#L279) |
...
| `getUsers` | GET | `get_current_user` | [779](src/client.ts#L779) |
...
| `getAttachmentsForPlanEntry` | ? | `?` | [1064](src/client.ts#L1064) |
| `getAttachment` | ? | `?` | [1080](src/client.ts#L1080) |
| `addAttachmentToCase` | ? | `?` | [1090](src/client.ts#L1090) |
| `addAttachmentToResult` | ? | `?` | [1104](src/client.ts#L1104) |
| `addAttachmentToRun` | ? | `?` | [1118](src/client.ts#L1118) |
| `addAttachmentToPlan` | ? | `?` | [1132](src/client.ts#L1132) |
| `addAttachmentToPlanEntry` | POST | `delete_attachment/${attachmentId}` | [1146](src/client.ts#L1146) |
