...
| Endpoint | Client method | CLI command | Skill recipe |
| --- | --- | --- | --- |
| [`GET get_dataset/{dataset_id}`](https://support.testrail.com/hc/en-us/sections/7077185274644-API-reference) | [`getDataset`](../src/modules/datasets.ts#L9) | `dataset get` | [command-table](../skill/SKILL.md#command-surface) |
| [`GET get_datasets/{project_id}`](https://support.testrail.com/hc/en-us/sections/7077185274644-API-reference) | [`getDatasets`](../src/modules/datasets.ts#L15) | `dataset list` | [command-table](../skill/SKILL.md#command-surface) |
| [`POST add_dataset/{project_id}`](https://support.testrail.com/hc/en-us/sections/7077185274644-API-reference) | [`addDataset`](../src/modules/datasets.ts#L21) | `dataset add` | [recipe #28](../skill/SKILL.md#28-data-driven-runs-via-variables--datasets) |
| [`POST delete_dataset/{dataset_id}`](https://support.testrail.com/hc/en-us/sections/7077185274644-API-reference) | [`deleteDataset`](../src/modules/datasets.ts#L33) | `dataset delete` | [recipe #28](../skill/SKILL.md#28-data-driven-runs-via-variables--datasets) |
| [`POST update_dataset/{dataset_id}`](https://support.testrail.com/hc/en-us/sections/7077185274644-API-reference) | [`updateDataset`](../src/modules/datasets.ts#L27) | `dataset update` | [recipe #28](../skill/SKILL.md#28-data-driven-runs-via-variables--datasets) |
