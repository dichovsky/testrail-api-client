...
| [`POST close_plan/{plan_id}`](https://support.testrail.com/hc/en-us/sections/7077185274644-API-reference) | [`closePlan`](../src/modules/plans.ts#L63) | `plan close` | [recipe #24](../skill/SKILL.md#24-plan-entries-lifecycle-add--add-run--update--delete-cascade) |
| [`POST delete_plan/{plan_id}`](https://support.testrail.com/hc/en-us/sections/7077185274644-API-reference) | [`deletePlan`](../src/modules/plans.ts#L69) | `plan delete` | [recipe #24](../skill/SKILL.md#24-plan-entries-lifecycle-add--add-run--update--delete-cascade) |
| [`POST delete_plan_entry/{plan_id}/{entry_id}`](https://support.testrail.com/hc/en-us/sections/7077185274644-API-reference) | [`deletePlanEntry`](../src/modules/plans.ts#L93) | `plan delete-entry` | [recipe #24](../skill/SKILL.md#24-plan-entries-lifecycle-add--add-run--update--delete-cascade) |
| [`POST delete_run_from_plan_entry/{run_id}`](https://support.testrail.com/hc/en-us/sections/7077185274644-API-reference) | [`deleteRunFromPlanEntry`](../src/modules/plans.ts#L113) | `plan delete-run-from-entry` | [recipe #24](../skill/SKILL.md#24-plan-entries-lifecycle-add--add-run--update--delete-cascade) |
...
| [`GET get_results_for_run/{run_id}`](https://support.testrail.com/hc/en-us/sections/7077185274644-API-reference) | [`getResultsForRun`](../src/modules/results.ts#L59) | `result list` | [recipe #8](../skill/SKILL.md#8-page-through-a-large-result-list) |
...
| [`POST add_result_for_case/{run_id}/{case_id}`](https://support.testrail.com/hc/en-us/sections/7077185274644-API-reference) | [`addResultForCase`](../src/modules/results.ts#L88) | `result add` | [recipe #14](../skill/SKILL.md#14-validate-a-payload-before-sending---dry-run) |
...
| [`POST add_results_for_cases/{run_id}`](https://support.testrail.com/hc/en-us/sections/7077185274644-API-reference) | [`addResultsForCases`](../src/modules/results.ts#L100) | `result add-bulk` | [recipe #12](../skill/SKILL.md#12-publish-bulk-results-from-a-ci-run) |
