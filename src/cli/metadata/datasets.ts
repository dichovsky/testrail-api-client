...
export const datasetActions: readonly ActionSpec[] = [
    ...
    },
    {
        resource: 'dataset',
        action: 'add',
        summary: 'Create a new dataset in a project, optionally with variable values',
        pathParams: [{ name: 'project_id', description: 'TestRail project ID' }],
        apiEndpoint: 'POST add_dataset/{project_id}',
        bodySchema: AddDatasetPayloadSchema,
        helpExample: `--data '{"name":"...","variables":{"browser":"Chrome"}}'`,
        isWrite: true,
    ...
    },
    {
        resource: 'dataset',
        action: 'update',
        summary: 'Update an existing dataset name and/or variable values',
        pathParams: [{ name: 'dataset_id', description: 'TestRail dataset ID' }],
        apiEndpoint: 'POST update_dataset/{dataset_id}',
        bodySchema: UpdateDatasetPayloadSchema,
        helpExample: `--data '{"variables":{"browser":"Firefox"}}'`,
        isWrite: true,
